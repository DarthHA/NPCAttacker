                ...
                if (projectile.type == ProjectileID.MagnetSphereBall)
                {
                    ...
                    if (flag14)
                    {
                        ...
                        if (projectile.localAI[0] > 8f)
                        {
                            ...
                            num443 *= num445;
                            num444 *= num445;
                            int protmp = Projectile.NewProjectile(vector32.X, vector32.Y, num443, num444, ProjectileID.MagnetSphereBolt, projectile.damage, projectile.knockBack, projectile.owner, 0f, 0f);
                            Main.projectile[protmp].npcProj = true;
                            Main.projectile[protmp].usesLocalNPCImmunity = true;
                            Main.projectile[protmp].localNPCHitCooldown = 10;
                            return false;
        ...
        public override bool PreKill(Projectile projectile, int timeLeft)
        {
            if (projectile.npcProj)
            {
                if (projectile.type == ProjectileID.Xenopopper)
                {
                    ...
                    {
                        int num269 = Dust.NewDust(projectile.Center, 0, 0, 171, 0f, 0f, 100, default, 1.4f);
                    ...
                    int protmp = Projectile.NewProjectile(projectile.Center, vector13, (int)projectile.localAI[0], projectile.damage, projectile.knockBack, projectile.owner, 0f, 0f);
                    Main.projectile[protmp].npcProj = true;
                ...
                {
                    int protmp = Projectile.NewProjectile(projectile.Center, Vector2.Zero, ProjectileID.BloodCloudRaining, projectile.damage, projectile.knockBack, projectile.owner, 0f, 0f);
                    Main.projectile[protmp].npcProj = true;
                    Main.projectile[protmp].usesLocalNPCImmunity = true;
                    Main.projectile[protmp].localNPCHitCooldown = 10;
                    return false;
                ...
                {
                    int protmp = Projectile.NewProjectile(projectile.Center, Vector2.Zero, ProjectileID.RainCloudRaining, projectile.damage, projectile.knockBack, projectile.owner, 0f, 0f);
                    Main.projectile[protmp].npcProj = true;
                    Main.projectile[protmp].usesLocalNPCImmunity = true;
                    Main.projectile[protmp].localNPCHitCooldown = 10;
                    return false;
