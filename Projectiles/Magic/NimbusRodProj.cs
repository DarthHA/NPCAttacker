...
namespace NPCAttacker.Projectiles
{
    public class NimbusRodProj : BaseAtkProj
	{
		public override void AttackEffect()
		{
			if (HasValidTarget())
			{
				int protmp = Projectile.NewProjectile(projectile.Center, projectile.velocity, ProjectileID.RainCloudMoving, projectile.damage, projectile.knockBack, projectile.owner, 0f, 0f);
