...
namespace NPCAttacker.Projectiles
{
    public class ApprenticeStaffT3Proj : BaseAtkProj
	{
		public override void AttackEffect()
		{
			...
			{
				int protmp = Projectile.NewProjectile(vector2, (vector24 + value6 * num204 * 1f).RotatedBy(num204 * num203, default), ProjectileID.ApprenticeStaffT3Shot, projectile.damage, projectile.knockBack, projectile.owner, 0f, 0f);
