    ...
    public class PoisonStaffProj : BaseAtkProj
	{
		public override void AttackEffect()
		{
			...
			for (int num140 = 0; num140 < num139; num140++)
			{
				...
				num141 *= num84;
				num142 *= num84;
				int protmp = Projectile.NewProjectile(projectile.Center, new Vector2(num141, num142), ProjectileID.PoisonFang, projectile.damage, projectile.knockBack, projectile.owner, 0f, 0f);
