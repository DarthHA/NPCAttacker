		...
		public override void AttackEffect()
		{
			if (HasValidTarget())
			{
				...
				for (int num112 = 0; num112 < num111; num112++)
				{
					...
					float num83 = GetTargetPos().Y + Main.screenPosition.Y - vector2.Y;
					if (num83 < 0f)
					{
						num83 *= -1f;
					}
					...
					int protmp = Projectile.NewProjectile(vector2.X, vector2.Y, speedX4, speedY5, ProjectileID.Blizzard, projectile.damage, projectile.knockBack, projectile.owner, 0f, Main.rand.Next(5));
