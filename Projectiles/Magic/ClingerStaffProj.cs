    ...
    public class ClingerStaffProj : BaseAtkProj
	{
		public override void AttackEffect()
		{
			if (HasValidTarget())
			{
				...
				int num195 = num193;
				while (num193 < Main.maxTilesY - 10 && num193 - num195 < 30 && !WorldGen.SolidTile(num194, num193) && !TileID.Sets.Platforms[Main.tile[num194, num193].type])
				{
					num193++;
				}
				if (!WorldGen.SolidTile(num194, num193) && !TileID.Sets.Platforms[Main.tile[num194, num193].type])
				{
					flag15 = true;
				}
				...
				if (!flag15)
				{
					int protmp = Projectile.NewProjectile(vector2.X, vector2.Y, 0f, 0f, ProjectileID.ClingerStaff, projectile.damage, projectile.knockBack, projectile.whoAmI, num197, num198);
